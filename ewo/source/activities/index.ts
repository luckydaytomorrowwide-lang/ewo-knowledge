...
import { FlattenLayoutRowsAC } from './FlattenLayoutRowsAC'
import { MergeLayoutRowsAC } from './MergeLayoutRowsAC'
import { AssembleLineResultsAC } from './AssembleLineResultsAC'
import { CoalesceAC } from './CoalesceAC'
import { RemoveEndBracketsAC } from './RemoveEndBracketsAC'
import { RetrieveAllColumnsAC } from './RetrieveAllColumnsAC'
import { ProcessLineColumnsAC } from './ProcessLineColumnsAC'
import { RetrieveButtonPropertiesAC } from './RetrieveButtonPropertiesAC'
import { ResolveKeyMapAC } from './ResolveKeyMapAC'
...
export function getCommonActivities(): ActivityMap {
  ...
  const activities = {
    ...
    FlattenLayoutRowsAC,
    MergeLayoutRowsAC,
    AssembleLineResultsAC,
    CoalesceAC,
    RemoveEndBracketsAC,
    RetrieveAllColumnsAC,
    ProcessLineColumnsAC,
    RetrieveButtonPropertiesAC,
    ResolveKeyMapAC,
